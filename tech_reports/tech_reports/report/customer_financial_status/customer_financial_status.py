...
class PartyLedgerSummaryReport(object):
    ...
    def get_columns(self):
        columns = [
            ...
            {
                "label": _("رصيد بداية الفترة"),  # Opening Balance
            ...
            {
                "label": _("اجمالي المنصرف"),  # Invoiced Amount
            ...
            {
                "label": "اجمالي المرتجع",  # Return Amount
            ...
            {
                "label": "اجمالي المتحصلات",  # Paid Amount
            ...
            {
                "label": "الرصيد المفتوح",  # Closing Balance
    ...
    def prepare_conditions(self):
        ...
        if self.filters.get("customer"):
            # customer = frappe.db.get_value("Customer Mapping", {"customer_name": self.filters.get("party")}, "customer_code")
